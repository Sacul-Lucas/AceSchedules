                ...
                <div class="card">
                    <div class="card-header">
                        <h4>Detalhes do agendamento
                            ...
                            <a href="/AceSchedules/Painel Admin Salas - Ace Schedules/Auditório/index.php" class="btn btn-primary float-end" style="margin-right:2%">Administração de usuários</a>
                        </h4>
                        Selecione a sala:
