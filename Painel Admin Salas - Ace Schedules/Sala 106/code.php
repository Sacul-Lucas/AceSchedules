...
if(isset($_POST['delete_schedule']))
{
    ...
    $query = "DELETE FROM sala1 WHERE id='$agendamento_id'";
...
if(isset($_POST['update_schedule']))
{
    ...
    $query = "UPDATE sala1 SET idSala='$idSala', dataAgendamento='$dataAgendamento', periodo='$periodo' WHERE id='$agendamento_id' ";
    $query_run = mysqli_query($con, $query);
...
if(isset($_POST['save_schedule']))
{
    ...
    $query = "INSERT INTO sala1 (id,idSala,dataAgendamento,periodo) VALUES ('$agendamento_id','$idSala','$dataAgendamento','$periodo')";
