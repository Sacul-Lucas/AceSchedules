...
import { getInitials, stringToColor } from '../Utils/functions/Formatter';
                            ...
                            <div className="flex h-full flex-column">
                                ...
                                <div className="overflow-y-auto">
                                        ...
                                        <li>
                                            ...
                                            <ul className="p-0 m-0 overflow-hidden list-none">
                                                <li>
                                                    ...
                                                    <Link className="flex w-full p-3 transition-colors cursor-pointer p-ripple align-items-center border-round text-700 hover:surface-100 transition-duration-150" to={'/Painel'}>
                                    ...
                                    <ul className="p-3 m-0 list-none">
                                        <li>
                                            ...
                                            <ul className="p-0 m-0 overflow-hidden list-none">
                                                <li>
                                                    <Link className="flex w-full p-3 transition-colors cursor-pointer p-ripple align-items-center border-round text-700 hover:surface-100 transition-duration-150" to={'/Historico'}>
                                    ...
                                    <ul className="p-3 m-0 list-none">
                                        <li>
                                            ...
                                            <ul className="p-0 m-0 overflow-hidden list-none">
                                                <li>
                                                <Link className="flex w-full p-3 transition-colors cursor-pointer p-ripple align-items-center border-round text-700 hover:surface-100 transition-duration-150" to="/Config">
                                ...
                                <div className="mt-auto">
                                    ...
                                    <a className="flex gap-2 p-3 m-3 transition-colors cursor-pointer align-items-center border-round text-700 hover:surface-100 transition-duration-150 p-ripple">
                                        <Avatar
                                        className="items-center justify-center align-middle text-slate-100"
