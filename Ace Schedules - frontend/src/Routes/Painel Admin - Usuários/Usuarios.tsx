...
export const Usuarios: React.FC = () => {
    ...
    return (
        <DefineApp cssPath="https://cdn.jsdelivr.net/npm/bootstrap@4.4.1/dist/css/bootstrap.min.css" appTitle="Ace Schedules - Painel administrador de usuários" appIcon="src/assets/icons/calendar-alt-solid.svg" isCssDiff={true}>
            <AdminPopups
                 idModal={'AddModal'}
