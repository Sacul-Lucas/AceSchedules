...
export const Usuarios: React.FC = () => {
    ...
    return (
        <DefineApp cssPath="src/Core/Css/Owned/AdminRoom.css" appIcon="src/assets/icons/admin-alt-solid.svg" appTitle={`Ace Schedules - Painel administrador de usuários`}>
