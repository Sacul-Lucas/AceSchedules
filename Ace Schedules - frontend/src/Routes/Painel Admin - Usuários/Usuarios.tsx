...
export const Usuarios: React.FC = () => {
    ...
    return (
        ...
        <div>
            ...
            <div className="!w-max p-8 bg-white rounded-2xl shadow-lg mt-4 ml-[20%]">
                <div className="row">
                    <div className="col-md-12">
                        <div className="card w-fit ">
                            ...
                            <div className="card-body w-100">
                                <table className="table table-bordered w-fit table-striped" id="usuarios">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Usuário</th>
                                    ...
                                    <tbody>
                                        {usuarios.length > 0 ? usuarios.map((usuario) => (
                                            <tr key={usuario.id}>
                                                ...
                                                <td className="!w-fit !place-items-center">
