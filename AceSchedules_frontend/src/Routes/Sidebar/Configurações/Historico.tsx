    ...
    const loadReservasPendentes = async () => {
        try {
            const input: Historyinput = {
                ...
                FilterDataInicio: formatDateForMySQL(FilterDataInicio!),
                FilterDataFim: formatDateForMySQL(FilterDataFim!),
                status: false
            };
    ...
    const loadReservasAprovadas = async () => {
        try {
            const input: Historyinput = {
                ...
                FilterDataInicio: formatDateForMySQL(FilterDataInicioAprovada!),
                FilterDataFim: formatDateForMySQL(FilterDataFimAprovada!),
                status: true
            };
